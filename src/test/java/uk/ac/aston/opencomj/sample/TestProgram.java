...
import uk.ac.aston.opencomj.IMetaArchitecture;
...
import uk.ac.aston.opencomj.OCMRecpMetaInfo;
...
public final class TestProgram {
    ...
    public static void main(final String[] args) {
        ...
        try {
            ...
            final IUnknown pSubIUnk = (IUnknown) pIOCM.createInstance("uk.ac.aston.opencomj.calculator.subtract.Subtract", "Subtract");
            final IUnknown pCalcIUnk = (IUnknown) pIOCM.createInstance("uk.ac.aston.opencomj.calculator.calculator.Calculator", "Calculator");
