...
package uk.ac.aston.components.opencomj.sample;
...
import uk.ac.aston.components.opencomj.ConnectedComponent;
import uk.ac.aston.components.opencomj.ICFMetaInterface;
...
import uk.ac.aston.components.opencomj.InvalidComponentTypeException;
import uk.ac.aston.components.opencomj.OCMConnInfo;
import uk.ac.aston.components.opencomj.OpenCOM;
import uk.ac.aston.components.opencomj.calculator.calculator.ICalculator;
...
public final class FrameworkTestProgram {
    ...
    public static void main(final String[] args) {
        ...
        try {
            pCFIUnk = (IUnknown) pIOCM.createInstance("uk.ac.aston.components.opencomj.calculator.framework.CalculatorFramework", "Framework");
        ...
        try {
            pAcceptIUnk = (IUnknown) pIOCM.createInstance("uk.ac.aston.components.opencomj.calculator.accept.Accept", "Accept");
        ...
        try {
            pAdder = pCF.createComponent("uk.ac.aston.components.opencomj.calculator.adder.Adder", "Adder");
        } catch (InvalidComponentTypeException ex) {
            System.err.println("Cannot create component - check class location " + ex.getMessage());
        }
        IUnknown pCal = null;
        try {
            pCal = pCF.createComponent("uk.ac.aston.components.opencomj.calculator.calculator.Calculator", "Calculator");
        } catch (InvalidComponentTypeException ex) {
            System.err.println("Cannot create component - check class location " + ex.getMessage());
        }
        ...
        IUnknown pSub = null;
        try {
            pSub = pCF.createComponent("uk.ac.aston.components.opencomj.calculator.subtract.Subtract", "Subtract");
        } catch (InvalidComponentTypeException ex) {
            Logger.getLogger(FrameworkTestProgram.class.getName()).log(Level.SEVERE, null, ex);
        }
