...
import uk.ac.aston.components.opencomj.calculator.Interceptors.PreAndPostMethods;
...
public final class TestProgram {
    ...
    public static void main(final String[] args) {
        ...
        try {
            final IUnknown pAdderIUnk = (IUnknown) pIOCM.createInstance("uk.ac.aston.components.opencomj.calculator.adder.Adder", "Adder");
            final IUnknown pSubIUnk = (IUnknown) pIOCM.createInstance("uk.ac.aston.components.opencomj.calculator.subtract.Subtract", "Subtract");
            final IUnknown pCalcIUnk = (IUnknown) pIOCM.createInstance("uk.ac.aston.components.opencomj.calculator.calculator.Calculator", "Calculator");
