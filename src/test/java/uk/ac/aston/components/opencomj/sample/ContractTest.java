...
public final class ContractTest {
    ...
    public static void main(final String[] args) {
        ...
        try {
            pAdderIUnk = (IUnknown) pIOCM.createInstance("uk.ac.aston.components.opencomj.calculator.adder.Adder", "Adder");
        ...
        try {
            pSubIUnk  = (IUnknown) pIOCM.createInstance("uk.ac.aston.components.opencomj.calculator.subtract.Subtract", "Subtract");
        ...
        try {
            pCalcIUnk  = (IUnknown) pIOCM.createInstance("uk.ac.aston.components.opencomj.calculator.calculator.Calculator", "Calculator");
