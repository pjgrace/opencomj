...
import uk.ac.lancs.opencomj.ConnectedComponent;
import uk.ac.lancs.opencomj.ICFMetaInterface;
...
public final class FrameworkTestProgram {
    ...
    public static void main(final String[] args) {
        ...
        try {
            pCFIUnk = (IUnknown) pIOCM.createInstance("uk.ac.lancs.sample.framework.CalculatorFramework", "Framework");
        ...
        try {
            pAcceptIUnk = (IUnknown) pIOCM.createInstance("uk.ac.lancs.sample.accept.Accept", "Accept");
        ...
        try {
            pAdder = pCF.createComponent("uk.ac.lancs.sample.adder.Adder", "Adder");
        } catch (InvalidComponentTypeException ex) {
            System.err.println("Cannot create component - check class location " + ex.getMessage());
        }
        IUnknown pCal = null;
        try {
            pCal = pCF.createComponent("uk.ac.lancs.sample.calculator.Calculator", "Calculator");
        } catch (InvalidComponentTypeException ex) {
            System.err.println("Cannot create component - check class location " + ex.getMessage());
        }
        ...
        IUnknown pSub = null;
        try {
            pSub = pCF.createComponent("uk.ac.lancs.sample.subtract.Subtract", "Subtract");
        } catch (InvalidComponentTypeException ex) {
            Logger.getLogger(FrameworkTestProgram.class.getName()).log(Level.SEVERE, null, ex);
        }
