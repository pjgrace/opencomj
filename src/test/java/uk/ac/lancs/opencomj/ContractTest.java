...
public final class ContractTest {
    ...
    public static void main(final String[] args) {
        ...
        try {
            pAdderIUnk = (IUnknown) pIOCM.createInstance("uk.ac.lancs.sample.adder.Adder", "Adder");
        ...
        try {
            pSubIUnk  = (IUnknown) pIOCM.createInstance("uk.ac.lancs.sample.subtract.Subtract", "Subtract");
        ...
        try {
            pCalcIUnk  = (IUnknown) pIOCM.createInstance("uk.ac.lancs.sample.calculator.Calculator", "Calculator");
